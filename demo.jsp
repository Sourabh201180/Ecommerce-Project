...
<body>
  ...
  <h1 id="gt" class="ml-5 mt-5"><b>${param.placeToVisit}</b></h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm">
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
          ...
          <div class="carousel-inner ">
            <c:forEach var="img_path" items="${placePics}" varStatus="a">
              <c:choose>
                <c:when test="${a.count==1}">
                  <div class="carousel-item active">
                    <img src="static/images/${img_path}" class="d-block w-100 ml-5" alt="...">
                  </div>
                </c:when>
                <c:otherwise>
      ...
      <div class="col-sm">
        <h1 id="gt" class="ml-5 mt-5"><b>About The ${param.placeToVisit}</b></h1>
        <p style=" word-spacing: 8px;">${param.largeContent}</p>
      </div>
    </div>
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  // const fetchImages = async () => {
    //     console.log("++++");
    //     let resp = await fetch('fetch_all_images.do?product_id='+abc);
